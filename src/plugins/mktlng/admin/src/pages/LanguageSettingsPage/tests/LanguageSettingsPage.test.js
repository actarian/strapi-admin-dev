...
// import mktlngReducers, { initialState } from '../../../hooks/reducers';
// import pluginId from '../../../pluginId';

// const TestWrapper = ({ children }) => {
//   const queryClient = new QueryClient();

//   const rootReducer = combineReducers(mktlngReducers);
...
describe('mktlng settings page', () => {
  ...
  //   expect(request).toBeCalledWith('/mktlng/locales/2', {
  //     method: 'PUT',
  ...
  describe('create', () => {
    ...
    //     }
    //     if (url.includes('/mktlng/locales')) return Promise.resolve([]);
