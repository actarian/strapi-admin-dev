...
import PagesSettingsHeader from './PagesSettingsHeader/PagesSettingsHeader';
import PagesSettingsTabs from './PagesSettingsTabs/PagesSettingsTabs';
...
function PagesSettings() {
  ...
  return (
    <>
      <PagesSettingsHeader metaComponent={ metaComponent.current } />
      { false &&
      ...
      <PagesSettingsTabs contentTypes={ contentTypes.current } onChange={ onChange } />
    </>
  );
};

export default memo(PagesSettings);
